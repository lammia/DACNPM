...
<body> 
  ...
  <div class="form-group">
    ...
    <input type="datetime" class="form-control" required="" id="formGroupExampleInput" name="begin" value="{{$festival->timeBeginFestival}}">
  </div>
  @if($errors->has('begin'))
  ...
  @endif
   ...
   <div class="form-group">
    ...
    <input type="datetime" class="form-control" required="" id="formGroupExampleInput" name="end" value="{{$festival->timeEndFestival}}">
  </div>
  @if($errors->has('end'))
    <div style="padding-left: 50px;">
