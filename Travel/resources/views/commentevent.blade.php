...
<body> 
  ...
  <table class="table table-hover table-bordered responstable example" style="border-collapse:collapse;">
    ...
    <div>
      @if (Session::has('flash_message03'))
      <div class="alert alert-success form-feedback" role="alert">
        {!! Session::get('flash_message03') !!}
      </div>
      @endif
      @if (Session::has('flash_message04'))
      <div class="alert alert-success form-feedback" role="alert">
        {!! Session::get('flash_message04') !!}
      </div>
    @endif 
    </div>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="/newcommentevent" method="POST" name="formplace" enctype="multipart/form-data"> 
                <input type="hidden" name="_token"  value="{!!csrf_token()!!}">

                  <div class="form-group">
                    <input type="hidden" class="form-control" name="event" value="{{$idevent}}" >
                  </div>
    ...
    <tr>
     ...
     <td>
      ...
      <a href="{{ url('/DeleteCommentEvent/'.$item->idComment) }}" class ="btn btn-danger" 
     ...
     <div class="modal fade" id="{{$item->idComment}}" role="dialog">
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="/editcommentevent/{{$item->idComment}}" method="POST" name="formplace" enctype="multipart/form-data"> 
                <input type="hidden" name="_token"  value="{!!csrf_token()!!}">
